...
import { usePhotographyData } from '../../../src/hooks/usePhotographyData';
import { photographyCategories as mockCategories } from '../../../src/data/photography';

jest.mock('../../../src/data/photography', () => ({
