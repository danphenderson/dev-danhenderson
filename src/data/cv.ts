...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    impactHighlights: [
      'Managed delivery of a 4-credit Calculus I section, including recorded lectures, assessments, grading, office hours, and course administration.',
      'Aligned content, grading standards, and student support with supervising faculty and fellow instructors across sections.',
      'Developed Mathematica walkthroughs to strengthen students\' conceptual understanding and computational fluency.',
      'Earned a 4.8/5.0 average student evaluation score (58% response rate).',
    ],
  ...
  },
  {
    ...
    projects: [
      ...
      'Developed a cost-effective, scalable PySpark analytics service to meet data governance requirements supporting platform`s HiTrust certification.',
      'Collaborated on a deduplication ML hook in the ingestion pipeline to embed a human-reinforcement trained model into the data platform.',
      'Assisted restricted-offshore developers via infrastructure deployments, code reviews, ETL support, and QA testing to accelerate delivery.',
    ],
